...
from .student_views import (
    society_browser, view_societies, society_creation_request, student_societies, join_competition, leave_competition
)
from .society_views import (
    event_creation, terminate_society, view_members, view_upcoming_events, create_post, edit_roles, 
    update_committee, manage_competitions, create_competition
)
