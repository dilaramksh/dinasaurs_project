...
from social_media.models import User, University, Society, Membership, Category, SocietyRole
...
class HomepageViewsTestCase(TestCase):
    ...
    def setUp(self):
         ...
         # Create university
         self.approved = University.objects.create(
            name="KCL",
            domain="kcl.ac.uk",
            status="approved",
         ...
         self.user = User.objects.create_user(
            ...
            password='testpass',
            university=self.approved,
            start_date=date(2022, 1, 1),
            end_date=date(2026, 1, 1)
        )

         self.category = Category.objects.create(name="Arts")
         ...
         self.society = Society.objects.create(
            ...
            status="approved",
            logo="society_logos/art.png"
        )

         # Society must exist before creating a SocietyRole
         self.society_role = SocietyRole.objects.create(
            role_name="President",
            society=self.society
        )

         # Now the Membership can be created with a role
