    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain', models.CharField(max_length=30, unique=True, validators=[django.core.validators.RegexValidator(message="Domain must start with '@', followed by at least three alphanumerics, and end with '.ac.uk'.", regex='^@\\w{3,}\\.ac\\.uk$')])),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('event', 'membership'), name='unique_event_participant')],
            },
        ),
