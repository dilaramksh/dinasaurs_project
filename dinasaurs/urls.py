...
urlpatterns = [
    ...
    #society paths
    path('society/<int:society_id>/dashboard/', get_society_dashboard, name='get_society_dashboard'), #name different
    #path('society/dashboard/', society_dashboard, name='society_dashboard'),
    path('society/<int:society_id>/create_event/', event_creation, name='event_creation'), # name different from view name should change
